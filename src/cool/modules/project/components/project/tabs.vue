<template>
	<el-tabs class="project-tabs" :lazy="true" v-model="activename" @tab-click="handleClick">
		...
		<el-tab-pane label="施工" name="consttab">
			<component :is="isConst"><slot name="consttab"></slot></component>
		</el-tab-pane>
...
import TabsConstTab from "./tabs-consttab.vue";
